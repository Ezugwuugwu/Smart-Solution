"""
Django settings for SmartSolutionProject project.
...
SECRET_KEY = 'django-insecure-(@6ey)xz9_56i7e!&i&_p5*++zt60ne-a9vjq2vqdf6ty3^0#x'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1', 'https://smart-solutn.herokuapp.com/', '0.0.0.0']
...
ROOT_URLCONF = 'SmartSolutionProject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'TechnicalAssessmentApp/Templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
